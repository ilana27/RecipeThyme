    ...
    enum Endpoints {
        ...
        var urlString: String {
            ...
            case .complexSearch(let query):
                return Endpoints.baseUrl + "/findByIngredients?apiKey=\(apiKey)&query=\(query.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed) ?? "")&instructionsRequired=true&addRecipeInformation=true&number=100"
            }
        }
